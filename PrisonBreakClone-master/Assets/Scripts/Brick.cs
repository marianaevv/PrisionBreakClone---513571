...
public class Brick : MonoBehaviour {
	...
	void PuffSmoke() {
        ...
        ParticleSystem p = smokePuff.GetComponent<ParticleSystem>();
        ParticleSystem.MainModule pmainm = p.main;
        pmainm.startColor = gameObject.GetComponent<SpriteRenderer>().color;
